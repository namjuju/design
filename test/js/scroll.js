$(document).ready(function(){
    ...
    function scroll_chk(){
        ...
        if((sec02_obj_top - scrolling - window_h) < -offset){
            ...
            if((500 - (sec02_obj_top - scrolling - window_h + offset)*1.2) <= $(window).width()){
                $('.sec02 .photo').width(500 - (sec02_obj_top - scrolling - window_h + offset)*1.2)
            }
        }else{
        ...
        if((sec05_obj_top - scrolling - window_h) < -offset){
            sec05_offset = (sec05_obj_top - scrolling - window_h + offset)*0.25
